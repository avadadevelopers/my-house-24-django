...
urlpatterns = [
    ...
    path('user-app_admin/role', views.user_admin_role_view, name='admin_user-admin-role'),
    path('user-app_admin/users/list', views.user_admin_users_list, name='admin_user-users-list'),
    path('user-app_admin/create', views.user_admin_create_view, name='admin_user-admin-create'),
    path('user-app_admin/change', views.user_admin_change_view, name='admin_user-admin-change'),
    path('user-app_admin/delete', views.user_admin_delete_view, name='admin_user-admin-delete'),
